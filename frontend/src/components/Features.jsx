        ...
        <div className="mt-16 bg-gradient-to-r from-gray-50 to-red-50 rounded-2xl p-8 border border-gray-200">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-gray-700 mb-6">
              Module complémentaire avec import CSV, grilles d'inspection conformes au Code de sécurité du Québec, gestion des préventionnistes et tableaux de bord avancés.
            </p>
            <div className="flex flex-wrap justify-center gap-3">
              {['Import CSV', 'Grilles d\'inspection', 'Gestion préventionnistes', 'Tableaux de bord'].map((tag, idx) => (
                <span
                  key={idx}
