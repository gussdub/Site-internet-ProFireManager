      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="mt-16 flex flex-col items-center">
            <p className="text-sm text-gray-500 mb-4">{heroData.trustBadge}</p>
            <div className="flex items-center gap-8">
              <div className="text-center">
                <div className="text-3xl font-bold text-[#D9072B]">{heroData.stats.demo}</div>
                <div className="text-sm text-gray-600">{heroData.stats.demoLabel}</div>
              </div>
              <div className="w-px h-12 bg-gray-300"></div>
              <div className="text-center">
                <div className="text-3xl font-bold text-[#D9072B]">{heroData.stats.cloud}</div>
                <div className="text-sm text-gray-600">{heroData.stats.cloudLabel}</div>
              </div>
              <div className="w-px h-12 bg-gray-300"></div>
              <div className="text-center">
                <div className="text-3xl font-bold text-[#D9072B]">{heroData.stats.support}</div>
                <div className="text-sm text-gray-600">{heroData.stats.supportLabel}</div>
              </div>
            </div>
          </div>
        </div>
