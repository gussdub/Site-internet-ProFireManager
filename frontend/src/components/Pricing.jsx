              ...
              <CardContent className="p-8">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-sm text-gray-500 mt-2">
                    {(calculatePrice(basePrices[index]) * exampleCounts[index]).toFixed(0)}$/{billingCycle === 'monthly' ? (language === 'fr' ? 'mois' : 'month') : pricingData.billedAnnually} ({exampleCounts[index]} {language === 'fr' ? 'pompiers' : 'firefighters'})
                  </p>
                  {billingCycle === 'annual' && (
